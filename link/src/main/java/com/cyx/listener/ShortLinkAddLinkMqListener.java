...
public class ShortLinkAddLinkMqListener {
    ...
    public void shortLinkHandler(EventMessage eventMessage, Message message, Channel channel) throws IOException {
        log.info("监听到消息ShortLinkAddLinkMqListener,message内容：{}", eventMessage);
        try {
            ...
            log.error("监听到消息ShortLinkAddLinkMqListener消费异常", e);
            throw new BizException(BizCodeEnum.MQ_CONSUMER_EXCEPTION);
        }
        log.info("监听到消息ShortLinkAddLinkMqListener消费成功,{}", eventMessage);
    }
}
